    ...
    public void inputPerekaman() {
        ...
        submitButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String pekerjaan = Controller.getSelectedJobs(checkKaryawanStasta, checkPNS, checkWiraswasta,
                        checkAkademisi, checkPengangguran);
                String wargaNegaraAsal = radioWNA.isSelected() ? citizenshipField.getText() : null;
                String kewarganegaraan = Controller.getCitizenship(KewarganegaraanGroup.getSelection().getActionCommand(),
                        wargaNegaraAsal);
